...
<h3 align=center><em>Due: 11:59pm, Sunday, July 23rd, 2023</em></h3>
...
4. For this assignment you should turn in **five** C++ files named `main.cpp`, `Entity.cpp`, `Entity.h`/`Entity.hpp`, `Map.cpp`, and `Map.h`/`Map.hpp`. You _must_ also submit any image and audio files that you used in your project. Do **not** submit any other files.
