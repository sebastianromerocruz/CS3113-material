...
//    }
//    
//    m_model_matrix_uniform      = glGetUniformLocation(m_program_id, "model_matrix");
//    m_projection_matrix_uniform = glGetUniformLocation(m_program_id, "projection_matrix");
//    m_view_matrix_uniform       = glGetUniformLocation(m_program_id, "view_matrix");
//    m_color_uniform             = glGetUniformLocation(m_program_id, "color");
//    m_light_position_uniform    = glGetUniformLocation(m_program_id, "light_position");
//    m_is_charging               = glGetUniformLocation(m_program_id, "is_charging");
//    
//    m_position_attribute = glGetAttribLocation(m_program_id, "position");
//    m_tex_coord_attribute = glGetAttribLocation(m_program_id, "tex_coord");
//    
...
//}
//
//void ShaderProgram::set_is_charging(const int is_charging)
//{
//    glUseProgram(m_program_id);
//    glUniform1i(m_is_charging, is_charging);
//}
