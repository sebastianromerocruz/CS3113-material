...
void initialise()
{
    ...
    // Your effects is initialized here
...
void update()
{
    ...
    while (delta_time >= FIXED_TIMESTEP) {
        ...
        /** Shake when player lands after jumping. In other words, this happens when there is a transition from George
             being in the air to landing on the ground, aka g_is_colliding_bottom from false to true */
