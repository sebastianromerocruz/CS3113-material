...
void initialise()
{
    ...
    display_window = SDL_CreateWindow("Hello, Spritesheets!",
    ...
    player_texture_id = load_texture(SPRITESHEET_FILEPATH);
...
void render()
{
    ...
    program.SetModelMatrix(model_matrix);
    draw_sprite_from_texture_atlas(&program, player_texture_id,
                                   animation_indices[animation_index],
