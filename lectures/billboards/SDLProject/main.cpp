...
const char* CUBE_OBJ_FILEPATH = "assets/cube.obj";
...
void initialise()
{
    ...
    floor_mesh->load_OBJ(CUBE_OBJ_FILEPATH, 50);
    ...
    crate_mesh->load_OBJ(CUBE_OBJ_FILEPATH, 1);
    ...
    state.crates[0].render_mode = REGULAR;
    ...
    state.crates[1].render_mode = REGULAR;
    ...
    state.crates[2].render_mode = REGULAR;
